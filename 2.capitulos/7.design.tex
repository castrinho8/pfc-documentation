...
compoñentes.
      ...
      Creouse unha clase sinxela que deben envolver a aqueles compoñentes que 
...
definida no Fragmento de Código~\ref{fig:design:test3}.
    ...
    \lstset{}
    \begin{lstlisting}[caption=Sentencia para indicar que non se cree un 
...
debe devolver, negacións ou outras validacións incluso máis complexas.
    ...
    \lstset{}
    \begin{lstlisting}[caption=Sentencia para comprobar a execución dun 
