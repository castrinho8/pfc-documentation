...
funcionando como unha API REST.\santiagosays{Que é REST? Eso é parte das tecnoloxías.
  ...
  Permite gran cantidade\santiagosays[]{Xuízo de valor} de funcionalidades como servir aplicacións 
directamente desde CouchDB así como un sistema de replicación incremental e de 
detección de conflictos.

\ProTip{En lugar de calificar de ``gran cantidade'' e nomear algunha;
  cabe describilo como que \emph{ten funcionalidades \textbf{que
      habitualmente non forman parte dos sistemas de xestión de bases
      de datos}, como a replicación incremental, a detección de
    conflitos, ou o acceso mediante unha interface REST aos datos}.}
